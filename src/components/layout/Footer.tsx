      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#EAF5EF] font-medium mt-2">
              Where Skin Meets Care, Women Meets Comfort
            </p>
            <p className="text-[#EAF5EF]/80 text-sm leading-relaxed mt-2">
              A premium Skin Care & Women&apos;s Health Clinic providing specialized treatments in Dermatology, Venereology, Obstetrics, and Gynaecology.
            </p>
          </div>
